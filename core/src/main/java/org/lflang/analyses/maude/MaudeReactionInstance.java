...
public class MaudeReactionInstance {
  ...
  public MaudeReactionInstance(ReactionInstance lfReaction, MaudeReactorInstance parent) {
    ...
    for (var trigger : lfReaction.triggers) this.triggers.add(resolveTrigger(trigger, "trigger"));
  ...
  private MaudeTriggerInstance resolveTrigger(TriggerInstance<?> lfTrigger, String role) {
